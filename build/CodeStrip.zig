...
fn make(step: *Step, prog_node: *std.Progress.Node) !void {
    ...
    _ = try step.evalZigProcess(&.{
        ...
        // b.fmt("--just-symbols={s}", .{file.?}),
        // "-o", full_dest_path,
        // b.fmt("--strip-symbol={s}", ),
        "--strip-symbol=isr_stub_next",
        "--strip-symbol=isr_handler",
        "--strip-symbol=isr_stub_next_err",
        "--strip-symbol=kernel_start",
        "--strip-symbol=_kernel_export_lib",
        "--strip-symbol=__zig_probe_stack",
        "--strip-symbol=kernel",
        "--strip-symbol=compiler_rt",
        "--strip-symbol=memcpy",
        "--strip-symbol=memset",
        "-x",
